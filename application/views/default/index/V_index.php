...
<body data-layout="index">
		...
		<div class="container">
			<div class="row no-gutters ai-c">
				...
				<div class="nav-list ml-at">
					...
					<div class="nav-item"><a class="btn btn-view-more" data-fancybox data-src="#block-register" style="color:white">Try for free</a></div>
				</div>
			</div>
		</div>
	</header>
	<main>
		...
		<section class="index-1">
			<div class="container">
				<div class="content">
					...
					<div class="ta-c mt-10px"><a class="btn btn-view-more" data-fancybox data-src="#block-register" style="color:white">Try for free</a></div>
				</div>
			</div>
		</section>
		<!--BLOCK 2 TRANG CHỦ-->
		<section class="index-2">
			<div class="block-item">
				<div class="list-item">
					<div class="item wow fadeInLeft" data-wow-delay=".2s">
						<h3>GET ORGANIZED</h3>
						<p class="lcl lcl-5">Plan and structure work in a way that’s best for you. Set priorities and deadlines. Share details and assign tasks. All in one place. Plan and structure work in a way that’s best for you. Set priorities and deadlines. Share details and assign tasks. All in one place.Plan and structure work in a way that’s best for you. Set priorities and deadlines. Share details and assign tasks. All in one place.</p>
					</div>
					<div class="item wow fadeInLeft" data-wow-delay=".2s">
						<h3>GET ORGANIZED</h3>
						<p class="lcl lcl-5">Plan and structure work in a way that’s best for you. Set priorities and deadlines. Share details and assign tasks. All in one place. Plan and structure work in a way that’s best for you. Set priorities and deadlines. Share details and assign tasks. All in one place.Plan and structure work in a way that’s best for you. Set priorities and deadlines. Share details and assign tasks. All in one place.</p>
		...
		<section class="index-3">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						<div class="content">
							<h2 class="wow bounceInLeft" data-wow-delay=".2s">Watch project in action</h2>
							<p class="wow fadeInUp" data-wow-delay=".2s">See how your team can structure work to turn all your goals into workable plans.</p>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="block-img">
			...
			<div class="container">
				<div class="slider-customer">
									...
									<figure>
										...
										<figcaption>
											<div class="content" data-setHeight>
												...
												<div class="name">Tamas Kada KLM</div>
												<div class="office">Business Development Manager</div>
											</div>
										</figcaption>
									</figure>
								</div>
					...
					<div class="thumbnail-image">
						...
						<div class="swiper-button-next btn" data-setHeight>See more Customer</div>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6 as-c wow flipInX" data-wow-delay=".2s">
						<div class="content" data-setHeight>
							<h2>Get the Forrester Wave™ report</h2>
							<p>Find out why Forrester thinks collaborative work management is essential for business success—and why Asana is named a leader in the market.</p><a class="link" href="#">Download the report</a>
						</div>
					</div>
				</div>
			</div>
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="logo text-center"><a href="index.html"><img class="lazyload blur-up" data-src="<?php echo base_url('assets/'); ?>logo.svg" alt="" srcset=""></a></div>
				</div>
			</div>
		</div>
	</footer>
	...
	<div class="d-n">
		<div id="block-login" data-max-width="900">
			...
			<div class="block-form-login">
				<form action="#" id="block-form-login" >
					...
					<div class="form-group">
						<button class="btn btn-view-more w-100" data-url="<?php echo site_url('auth/login'); ?>">Login</button>
					</div>
				</form>
			</div>
			<div class="or ta-c">or</div>
			<form action="#" id="block-form-forget">
				<div class="form-group">
					<label>Forget Password</label>
					<input type="text" name="email" placeholder="Your email: name@company.com">
				</div>
				<div class="form-group">
					<button class="btn btn-view-more w-100" data-url="<?php echo site_url('forget_password'); ?>">Recover</button>
				</div>
			</form>
		</div>
	</div>
	<div class="d-n">
		<div id="block-register" data-max-width="900">
			<h2>Register</h2>
			<div class="block-form">
				<form action="#">
					...
					<div class="form-group">
						<button class="btn btn-view-more w-100"  data-url="<?php echo site_url('register_save'); ?>">Login</button>
					</div>
				</form>
			</div>
		</div>
