...
function sortTable(td_element,ignoreLastLines) {
 ...
 var sortImages =[base_url+'static/directory/img/desc.gif',base_url+'static/directory/img/asc.gif',base_url+'static/directory/img/none.gif',base_url+'static/directory/img/sorting.gif']; 
